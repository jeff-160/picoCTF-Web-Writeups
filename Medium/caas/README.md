...
`cowsay` is a linux tool that generates ASCII art with custom messages. The webpage is most likely using the tool through `subprocess` or a similar Python libraries, making it susceptible to command injection.  
